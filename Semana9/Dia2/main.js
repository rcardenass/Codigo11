...
//Object.assign (crea copia de objetos)
...
console.log('Object.key', Object.keys(copia));

//Object.values (entrega coleccion con los valores del objeto)
console.log('Object.values', Object.values(copia));

//Object.hasownProperty (entrega valor bolleano si la propiedad existe en el objeto)
console.log('Object.values', copia.hasOwnProperty('age'));
...
//toFixed
console.log(Number.parseFloat('3.14').toFixed(15));
